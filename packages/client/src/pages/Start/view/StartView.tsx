import Select, { SelectKind } from '@components/Select/Select';
...
export default function StartView({ username, onStart, ...rest }: StartViewProps) {
  return (
    <>
      <h3 className={styles.title}>Привет, {username}</h3>
      <p className={styles.text}>Выбери уровень и начни игру)</p>
      <Select<LevelListType> variant={SelectKind.Purple} {...rest} />
